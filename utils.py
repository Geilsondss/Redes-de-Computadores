...
def mostrar_comandos_livres():
    ...
    print("-" * 70)
    print("/connect <Nome>                      → Conecta a um peer específico.")
    ...
    print("/exit                                → SEMPRE FINALIZE A EXECUÇÃO COM ESSE COMANDO")
    print("-" * 70)

def mostrar_comandos_P2P():
    print("\n<SISTEMA>: Comandos disponíveis:")
    print("-" * 70)
    print("/peers                               → Exibe as conexões ativas com outros peers.")
    print("/active                              → Exibe os peers ativos.")
    print("/disconnect <Nome>                   → Desconecta a conexão com um peer específico.")
    print("/clear                               → Limpa a tela de apresentação")
    print("/menu                                → Exibe os comandos disponíveis")
    print("/rooms                               → Lista todas as salas disponíveis.")
    print("/exit                                → SEMPRE FINALIZE A EXECUÇÃO COM ESSE COMANDO")
...
def mostrar_comandos_sala():
    ...
    print("/clear                               → Limpa a tela de apresentação")
    print("/menu                                → Exibe os comandos disponíveis")
    print("/add_in_room <Nome>                  → Adiciona a um peer específico a uma sala (apenas criador).")
    print("/kick_peer <Nome>                    → Expulsa um usuário da sala (apenas criador).")
